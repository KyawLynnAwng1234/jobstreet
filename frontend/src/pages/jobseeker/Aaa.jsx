    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow flex justify-center items-center px-4">
        <div className="bg-blue-50 rounded-lg p-8 w-full max-w-md shadow-md">
          ...
          {/* Google */}
          <button className="w-full mb-3 flex items-center justify-center gap-2 border 
                             border-gray-400 rounded-lg py-2 hover:bg-gray-100 
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow flex justify-center items-center px-4">
        <div className="bg-blue-50 rounded-lg p-8 w-full max-w-md shadow-md">
          ...
          <h2 className="text-center text-3xl font-extrabold mb-6">Register</h2>
